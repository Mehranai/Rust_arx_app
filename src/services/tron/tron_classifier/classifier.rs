...
pub fn classify(
        ...
        )
    {
        return ClassificationResult {
            ...
            protocol:
            protocol_info.protocol.to_string(),

            category:
            protocol_info.category,

            confidence:
            boost_confidence(
                protocol_info.confidence,
                true,
                false,
                false,
            ),
